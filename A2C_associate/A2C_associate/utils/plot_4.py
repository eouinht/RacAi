...
def plot_accept_bar_single(run_path, ue_label="Run", divide_by=None):
    enable_latex_font()
    algos  = ["RandomRU", "RoundRobin", "NearestRU", "PPO-GraphSAGE"]
    labels = ["Random-RU", "RoundRobin", "Nearest-RU", "PPO-GSA"]
    colors = ['#C2C2C2', '#A6D854', '#80B1D3', '#D95F02']
    hatches  = ['/', '.', 'o', '//']
    bar_w, gap = 40, 10
...
# =======================================================
def main_2(root_dir="./results_final_6",
           runs=("run_30UE_20260129_170112", "run_40UE_20260130_014446", "run_50UE_20260130_120627"),
