...
# =======================================================
ALGOS  = ["RandomRU", "RoundRobin", "NearestRU", "PPO-GraphSAGE", "A2C-MLP" , "MILP"]
LABELS = ["Random-RU", "RoundRobin", "Nearest-RU", "PPO-GSA", "A2C-MLP" , "Optimal"]

# === IEEE-style pastel palette with strong highlights for PPO & MILP ===
COLORS = ['#C2C2C2', '#A6D854', '#80B1D3', '#D95F02', "#1F0F03", '#1B9E77']
HATCH  = ['/', '.', 'o', '//', '///', '']
...
if __name__ == "__main__":
    main_1("./results_final/run_20260119_221640", ue_label="single", divide_by=20)
